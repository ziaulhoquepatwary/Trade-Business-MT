    ...
    return (
        <footer className="w-full mt-20 relative overflow-hidden transition-colors duration-300 bg-white dark:bg-black border-t border-slate-200 dark:border-slate-900 text-slate-600 dark:text-slate-400">
            ...
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex justify-center items-center pointer-events-none select-none z-0 overflow-hidden w-full">
                <span className="text-[18vw] font-black leading-none tracking-tighter uppercase whitespace-nowrap opacity-[0.04] dark:opacity-[0.07] text-slate-900 dark:text-white">
                    TRADECHAIN
                </span>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 pb-12 border-b border-slate-200 dark:border-slate-900">
                    ...
                    <div className="flex flex-col space-y-4">
                        <div className="flex items-center">
                            <Link href="/" className="group">
                                <div className="flex items-center gap-2.5">
                                    <div className="relative w-10 h-10 rounded-xl bg-slate-900 dark:bg-white flex items-center justify-center shadow-md transition-transform group-hover:scale-105">
                                    ...
                                    <div className="hidden sm:flex flex-col">
                                        ...
                                        <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium uppercase tracking-widest mt-1">
                                            Global Logistics
                                        </span>
                                    </div>
                                </div>
                        ...
                        <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                            End-to-end cold chain logistics and seafood procurement provider — delivering IoT-monitored, HACCP-compliant, and sustainably sourced global supply chain solutions.
                        </p>
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <a
                                ...
                                className="w-9 h-9 flex items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-slate-600 dark:text-slate-400 hover:border-slate-900 hover:text-slate-900 dark:hover:border-white dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-900 transition-all cursor-pointer"
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5 text-sm">
                            {quickLinks.map((link) => (
                                <li key={link.name}>
                                    <Link href={link.href} className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-2 group">
                                        <ArrowRight className="w-3.5 h-3.5 text-slate-400 dark:text-slate-600 group-hover:text-slate-900 dark:group-hover:text-white group-hover:translate-x-0.5 transition-all" />
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start gap-3">
                                <span className="mt-1 text-slate-900 dark:text-slate-100">
                                    <Mail className="w-4 h-4" />
                                </span>
                                <div>
                                    <p className="font-medium text-slate-800 dark:text-slate-200">Email Support</p>
                                    <a href={`mailto:${emailAddress}`} className="text-xs text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors">
                                        {emailAddress}
                                    </a>
                                </div>
                            </li>
                            ...
                            <li className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-xs text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors block"
                                    >
                                        +1 (316) 361-7579
                                    </a>
                                </div>
                    ...
                    <div>
                        ...
                        <div className="mt-5 p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs text-slate-500 space-y-1">
                            <p className="font-semibold text-slate-800 dark:text-slate-200">Florida LLC · Doc# L26000290590</p>
                            <p className="text-slate-500">7901 4th St N Suite 6573, St. Petersburg FL 33702</p>
                        </div>
                    </div>
