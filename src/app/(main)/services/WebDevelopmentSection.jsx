...
import { Code2, Globe, ShoppingCart, Layout, Cpu, Layers, CheckCircle2 } from 'lucide-react';
...
export default function WebDevelopmentSection() {
    ...
    return (
        <section className="relative w-full py-10 px-4 sm:px-8 lg:px-16 transition-colors duration-300 bg-[#EDE8F5] dark:bg-[#000000] text-gray-800 dark:text-gray-100 overflow-hidden">
            ...
            {/* 💡 Slowly Sliding Ambient Background Glow (One side to another) */}
            ...
            <div className="relative z-10 mx-auto space-y-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    ...
                    {/* Key Features Card with Rotating Border Effect */}
                    <motion.div
                    ...
                    >
                        ...
                        <div className="absolute -inset-[1.5px] bg-gradient-to-r from-[#3D52A0] via-[#7088D6] to-[#3D52A0] dark:from-blue-500 dark:via-indigo-500 dark:to-blue-500 rounded-2xl opacity-40 group-hover:opacity-100 blur-sm group-hover:blur-md transition-all duration-500 animate-[pulse_3s_infinite]" />

                        <div className="relative p-6 sm:p-8 rounded-2xl bg-white/80 dark:bg-[#09090b]/90 border border-gray-200 dark:border-gray-800 shadow-2xl backdrop-blur-md space-y-6">
                            <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-4">
                                ...
                                <span className="flex gap-1.5">
                                    <span className="w-3 h-3 rounded-full bg-red-400/80 inline-block shadow-sm"></span>
                                    <span className="w-3 h-3 rounded-full bg-yellow-400/80 inline-block shadow-sm"></span>
                                    <span className="w-3 h-3 rounded-full bg-green-400/80 inline-block shadow-sm"></span>
                                </span>
                            </div>
