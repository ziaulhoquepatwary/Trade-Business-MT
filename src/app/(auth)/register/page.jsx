...
import { Eye, EyeOff, Mail, Lock, User, Image as ImageIcon, ArrowRight, Anchor, Globe, MoveLeft, Loader2 } from "lucide-react";
        ...
        <div className="max-w-md w-full space-y-6 bg-white dark:bg-black border-2 border-black dark:border-white p-8 sm:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] relative z-10 my-8">
            ...
            <form onSubmit={handleSubmit(handleRegister)} className="space-y-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 bg-zinc-50 dark:bg-zinc-950 border text-sm font-mono focus:outline-none transition-all text-black dark:text-white placeholder:text-zinc-400 ${errors.name
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 bg-zinc-50 dark:bg-zinc-950 border text-sm font-mono focus:outline-none transition-all text-black dark:text-white placeholder:text-zinc-400 ${errors.email
                                ? "border-red-600 focus:ring-1 focus:ring-red-600"
                                : "border-black dark:border-white focus:bg-white dark:focus:bg-black"
                                }`}
                        />
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className={`w-full pl-10 pr-12 py-3 bg-zinc-50 dark:bg-zinc-950 border text-sm font-mono focus:outline-none transition-all text-black dark:text-white placeholder:text-zinc-400 ${errors.password
                                ? "border-red-600 focus:ring-1 focus:ring-red-600"
                                : "border-black dark:border-white focus:bg-white dark:focus:bg-black"
                                }`}
                        />
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-2 flex items-center justify-center gap-2 bg-black hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-black font-mono font-bold text-xs uppercase tracking-widest py-3.5 transition-all duration-200 group cursor-pointer border border-black dark:border-white disabled:opacity-50"
                >
                    {loading ? (
...
export default function Register() {
    return (
        <section className="min-h-screen bg-white dark:bg-black text-black dark:text-white flex items-center justify-center p-4 transition-colors duration-300 relative font-sans py-12">
            ...
            {/* Suspense Wrapper to handle searchParams safely */}
            <Suspense fallback={<div className="font-mono text-xs uppercase tracking-widest">Loading...</div>}>
                <RegisterForm />
            </Suspense>
        </section>
    );
